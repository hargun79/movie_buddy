...
class ChoosingScreenBody extends StatefulWidget {
  @override
  _ChoosingScreenBodyState createState() => _ChoosingScreenBodyState();
}

class _ChoosingScreenBodyState extends State<ChoosingScreenBody> {
  @override
  Widget build(BuildContext context) {
    return MyChoosingScreenBody();
  }
}

class MyChoosingScreenBody extends StatefulWidget {
  @override
  _MyChoosingScreenBodyState createState() => _MyChoosingScreenBodyState();
}
                  ...
                  child: TextButton(
                      ...
                      onPressed: () {
                        if (!widget.isSelected) {
                          ...
                          if (mp.length < 5) isButtonDisabled = true;
                        }
                      },
